...
namespace ClassDemoOfDiffDesignPatterns
{
    class PatternWorker
    {
        ...
        {
            // No offer
            IState calc = new DemoStateOrdinary();
            Console.WriteLine("Price without offer " + calc.CalculatePrice(1000));

            // Change state
            calc = calc.NextState(true);
            Console.WriteLine("Price offer " + calc.CalculatePrice(1000));
        }
    }
}